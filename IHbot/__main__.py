...
*Main* commands available:
 ...
 - /donate: information about how t donate!
 - /settings:
...
It took lots of work for [my creator](t.me/Arman_xD) to get me to where I am now, and every donation helps \
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("IHbot.modules." + module_name)
